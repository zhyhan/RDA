...
def train_batch(model_instance, inputs_source, labels_source, inputs_target, optimizer, iter_num, max_iter):
    ...
    total_loss = model_instance.get_gradual_loss(inputs, labels_source, max_iter)
...
if __name__ == '__main__':
    ...
    lr_scheduler = INVScheduler(gamma=cfg.lr_scheduler.gamma,
                                ...
                                init_lr=cfg.init_lr)
    to_dump = train(model_instance, train_source_clean_loader, train_source_noisy_loader, train_target_loader, test_target_loader, group_ratios, max_iter=15000, optimizer=optimizer, lr_scheduler=lr_scheduler, eval_interval=1000)
